...
def links():
    ...
    переменной URL. Функция возвращает извлечённые данные. Данные представены в виде кортежа, в котором находятся 7 элементов, где
    guns1[0] - первый элемент списока, 
    guns2[0] - первый элемент списока, 
    guns3 - строка, 
    guns4 - строка, 
    guns5 - строка, 
    guns6 - строка, 
