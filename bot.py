...
def get_text_messages(message):
        ...
        функция получает на вход переменную message типа str.
...
def wep_id(message):
    ...
    """
    message -- команда от пользователя.
    функция получает на вход переменную message типа str, её значение записывается в глобальную переменную weapon типа str, затем
...
def wep_sk(message):
    ...
    """
    message -- команда от пользователя.
    функция полуает на вход переменную message типа str, оно записывается в глобальную переменную name типа str
...
def links():
    ...
    """"в функции links() происходит обращение к глобальным переменнымweapon и name. Методом replace изменяется исходное значение в 
    переменной URL. В конце работы функции происходит запуск функции Parse()
    """
